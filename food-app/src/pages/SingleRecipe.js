...
export default class SingleRecipe extends Component {
    constructor(props) {
     ...
     async componentDidMount() {
         const url = `https://www.food2fork.com/api/get?key=dc882939d7612dddd130586884a7fdfe&rId=${this.state.id}`;
         try{
           ...
           <div className="container my-5">
             ...
             alt="recipe" />
                   ...
                   <div className="col-10 mx-auto col-md-6 my-3">
                       ...
                       noreferrer" className="btn btn-primary mt-2 text-capitalize">
                           publisher webpage
                       </a>

                       <a href={source_url} target="_blank" rel="noopener
                       noreferrer" className="btn btn-success mt-2 mx-2 text-capitalize">
                           recipe url
                       </a>
